...
export async function createQuotationRequest(params: {
  ...
  return prisma.quotationRequest.create({
    data: {
      ...
      wantsTechnical3DProject: params.data.wantsTechnical3DProject,
      technical3DProjectFeeCents: params.data.wantsTechnical3DProject ? 10000 : null,
      wantsTechnicalVisit: params.data.wantsTechnicalVisit,
